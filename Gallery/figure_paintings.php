...
<head>
    ...
    <title>Figure-paintings Gallery</title>
    <style>
        .gallery {
            display: flex;
            flex-wrap: wrap;
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="galleryDropdown">
              ...
              <li><a class="dropdown-item active" href="figure_paintings.php">Figure Paintings</a></li>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                   echo "<div class='image-container'>";
                        echo "<a href='image.php?id=" . $row['id'] . "'>";  // Make image clickable and pass ID in URL
                        echo "<img class='images' src='" . htmlspecialchars($row['image_path']) . "' alt='" . htmlspecialchars($row['title']) . "'>";
                        echo "</a>";
