...
// Prepare and execute the query to fetch landscape category images
$category = "Landscape";
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="galleryDropdown">
                        ...
                        <li><a class="dropdown-item active" href="landscape.php">Landscape</a></li>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<div class='image-container'>";
                    // Make image clickable and pass ID in URL
